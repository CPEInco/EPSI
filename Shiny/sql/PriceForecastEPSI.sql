...
SELECT 
/*Datepart(Hour,ValueDateCET) + 1 as EPSI,*/
[DE], [AT], [FR], [CH], [IT Nord], [HU], [SI], [UK], [NL], [BE], [ES], [CZ], [DK1], [DK2], [SE4],[SE3], [FI],[RO],[PL],[HR],[SK],  ForecastDateCET, ValueDateCET
...
WHERE ForecastDate = maxForecastDate) T1
PIVOT(MAX([Value]) FOR Area IN([DE], [AT], [FR], [CH], [IT Nord], [HU], [SI], [UK], [NL], [BE], [ES], [CZ], [DK1], [DK2], [SE4],[SE3],[FI],[RO],[PL],[HR],[SK] )) as pvt
order by ValueDateCET asc
