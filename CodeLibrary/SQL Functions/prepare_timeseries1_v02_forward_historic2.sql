--rignore
   ...
   SET @startDate = '2022-03-01 23:00'
   SET @endDate = '2022-04-07 23:00'
   SET @dayslag = 2
   SET @hourbefore = 11
...
WHERE ValueDateUTC >= CAST(@startDate AS datetime2(0))
	...
	--AND CurveID IN(1000300131,1000300127,1000300128,1000300129,1000300130)
...
-- <QueryInfo> QueryName: X:\DA\Tools\EPSI\upload\SQL\prepare_timeseries1_v02_forward_historic2.sql, CriticalQuery: True </QueryInfo>